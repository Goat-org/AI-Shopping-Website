                ...
                <form id="admineditimagesform" enctype="multipart/form-data" method="POST" action="admineditimages.php?fldproductid=<?php echo $productid; ?>" style="text-align: center;">
                  ...
                  <div class="form-group">
                    <?php while($row = $product->fetch_assoc()) { ?>
                      <input type="hidden" name="fldproductname" value="<?php if(isset($row['fldproductname'])){ echo $row['fldproductname']; }else{ header('location: ../sellers/adminproducts.php?errormessage=Error Occured, Try Again.'); }?>"/>
                      <input type="hidden" name="fldproductid" value="<?php if(isset($row['fldproductid'])){ echo $row['fldproductid']; }else{ header('location: ../sellers/adminproducts.php?errormessage=Error Occured, Try Again.'); }?>"/>
